...
class AdminControllerEn extends Controller
{
    ...
    public function registerProcurment (Request $request) {
        ...
        try {
            ...
            ProductProcurement::upsert([
                ['ref_procurementList_id' => $productProcurementListId, 'type' => 0, 'ko' => 1, ],
                ['ref_procurementList_id' => $productProcurementListId, 'type' => 1, 'ko' => 1, ],
                ['ref_procurementList_id' => $productProcurementListId, 'type' => 2, 'ko' => 1, ],
                ['ref_procurementList_id' => $productProcurementListId, 'type' => 3, 'ko' => 1, ],
                ['ref_procurementList_id' => $productProcurementListId, 'type' => 4, 'ko' => 1, ],
            ], [], []);
            
            $data = ProductProcurement::select('id', 'type', 'ref_procurementList_id')->where('ref_procurementList_id', '=', $productProcurementListId)->first();
