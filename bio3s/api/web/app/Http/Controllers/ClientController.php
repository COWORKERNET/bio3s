...
class ClientController extends Controller
{
    ...
    public function productProdcurement(Request $request) {
        ...
        try {
            ...
            $list = $productProcurementList->where('status', 0)->pluck('id');
            ...
            $query->whereIn('productProcurement.ref_procurementList_id', $list);
    ...
    public function boardDetail(Request $request) {
        ...
        try {
            ...
            Board::where('id', $id)->increment('count');
